    ...
    : [
        ...
        ...(completable.length
          ? [
              ...
              '',
              '**Export `ADLC_MANIFEST_KEY` first.** Every ticket here declares a rail, so',
              'the store is a frozen trust root and each write is an audited override that',
              'must be signed. Without the key the command refuses and changes nothing.',
              '',
              '```bash',
