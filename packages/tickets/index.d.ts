...
export function resolveOpenSegment(dir: string, options?: { cwd?: string; key?: string | null }): { name: string; isNew: boolean; anchor?: Record<string, unknown> | null; branch?: string };
...
export function discoverSegments(dir: string): { valid: string[]; invalid: { name: string; reason: string }[] };
export function readLineageToken(dir: string): { segment: string; ulid: string; branch: string } | null;
export function ulidOf(segmentName: string): string;
