...
`@adlc/core` provides `activeTickets` to filter completed tickets (drop completed
tickets and strip edges pointing to them, keeping the remaining DAG valid) so
backlog enumerators do not schedule finished work.
