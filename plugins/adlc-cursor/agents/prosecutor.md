...
<!-- readonly:false — optional orchestrator may run mechanical shell gates
(hollow-test / behavior-diff). Every lens + verifier agent must keep readonly:true. -->
# ADLC Prosecutor (P5)
...
`/adlc-prosecute` instead, which invokes the
