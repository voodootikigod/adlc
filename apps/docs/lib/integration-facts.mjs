...
export const CLAUDE_CODE_INTEGRATION = {
  ...
  surfaces: [
    ...
    },
    {
      ...
      count: 4,
      label: 'hook events',
      title: 'Hooks on session, edit, and stop',
      detail: 'SessionStart warns if you are not ready. PreToolUse enforces rails and the build-gate. PostToolUse watches churn. Stop audits evidence and risk-gated review.',
...
export const ANTIGRAVITY_INTEGRATION = {
  ...
  surfaces: [
    ...
    },
    {
      ...
      detail: 'Pairs with hollow-test and behavior-diff so P5 is more than a quick look at the diff.',
      items: ['prosecutor'],
    },
  ],
  surfacesSection: {
