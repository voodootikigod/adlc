...
| Tool | What it does |
| --- | --- |
| [tickets](/docs/toolkit/tickets) | Canonical sharded ticket store, migration bridge, transactions, archive, and provenance. |
...
| [ticket-prune](/docs/toolkit/ticket-prune) | Report and archive stale, already-shipped tickets out of the active store. |
...
| [context-handoff](/docs/toolkit/context-handoff) | Absolute context bands and session-terminal mutation deny (D1–D3) for F3 continuity. The deny is not wired by any harness by default since 1.11.1 (opt-in on pi and OpenCode). |
...
| [core](/docs/toolkit/core) | Shared library: exit-code helpers, provider selection, ledger, ticket, rail, and mutation primitives. |
