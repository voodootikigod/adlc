...
<div style={{ display: 'grid', gap: '0.25rem' }}>
  ...
  <span style={{ color: 'var(--adlc-wish)' }}>**1**: operational error (`gh` missing, auth failure, no PRs found, all PR details failed to fetch, bad arguments, or LLM refinement failed for all clusters).</span>
