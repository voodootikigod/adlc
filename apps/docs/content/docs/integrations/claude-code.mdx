...
| **P3–P4 Rail & Build** | `adlc rails-guard` | Hooks block frozen-rail edits, fitness-to-build, and context-rot handoff deny (D1–D3) on Edit/Write/Bash. |
...
- **Hooks:** structured-edit rails-guard, build-gate, context-handoff deny (Edit/Write/Bash) + CI backstop.
