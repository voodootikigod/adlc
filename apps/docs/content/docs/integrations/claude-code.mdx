...
| **P3–P4 Rail & Build** | `adlc rails-guard` | Hooks block frozen-rail edits and gate fitness-to-build on structured edits (Edit/Write/MultiEdit/NotebookEdit). |
...
- **Commands:** `/adlc:adlc-init`, `/adlc:adlc-ticket`, `/adlc:adlc-prosecute`, `/adlc:adlc-distill`, `/adlc:adlc-maintain`.
...
- **Hooks:** structured-edit rails-guard and build-gate + CI backstop. The context-handoff deny is not wired since 1.11.1 ([#966](https://github.com/voodootikigod/adlc/issues/966)); see [context-handoff](/docs/toolkit/context-handoff).
