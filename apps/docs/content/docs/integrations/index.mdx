---
title: Integrations
description: "Native ADLC integrations for Google Gemini (Antigravity/JetSki), Claude Code, Codex, Cursor, opencode, and pi."
---
...
- **[Google Gemini (Antigravity & JetSki)](/docs/integrations/gemini)** is a native plugin with an
...
Antigravity/JetSki (Gemini), opencode, pi, and Cursor let a single fleet run build tickets on any
