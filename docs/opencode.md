...
| `/adlc-ticket` | P0 | Runs an interactive triage interview to evaluate task risk × blast radius (categorizing it as Trivial, Bounded, Substantial, or Architectural) and authors a schema-valid ticket contract in `.adlc/tickets.json`. |
