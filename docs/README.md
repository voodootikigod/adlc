...
- [Google Gemini integration](./integrations/gemini.md) explains how to install
  and use the Gemini plugin (Antigravity and JetSki), including the advisory in-session
  hook and unbypassable CI gate.
